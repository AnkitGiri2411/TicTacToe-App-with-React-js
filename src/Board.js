...
const Board = ({ reset, setReset, winner, setWinner }) => {
	...
	const [winingplayer1,setWinningPlayer1] = useState();
	const [winingplayer2,setWinningPlayer2] = useState();
	...
	useEffect(() => {
		...
		setWinningPlayer1(P1);
		setWinningPlayer2(P2);
	...
	useEffect(() => {
		...
		if (checkWin()) {
			setWinner(turn === 0 ? winingplayer2+" Wins!" :
			winingplayer1+" Wins!");
		} else if (checkTie()) {
